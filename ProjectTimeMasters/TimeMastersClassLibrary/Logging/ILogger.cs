...
namespace TimeMastersClassLibrary.Logging
{
    public interface ILogger
    {
        ...
        void Log<T>(LogLevel level, string userId, string userName, string message, string payload);
